...
public class HttpServletResponseWrapper implements HttpServletResponse {
    ...
    public HttpServletResponseWrapper(ByteArrayOutputStream outputStream, Map<String, List<String>> headers) {
    ...
    public void addIntHeader(String s, int i) {
        this.headers.computeIfAbsent(s, k -> new java.util.ArrayList<>()).add(String.valueOf(i));
    ...
    public void setLocale(Locale locale) {
        this.headers.put("Content-Language", List.of(locale.toLanguageTag()));
